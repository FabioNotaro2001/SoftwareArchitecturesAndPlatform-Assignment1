...
import sap.ass01.layered.service.UserGUICallback;
import sap.ass01.layered.service.UserService;

public class UserGUI extends JFrame implements ActionListener, UserGUICallback {
    private UserService userService; // Service to manage user-related actions.
    ...
    private UserInfo userConnected; // Currently connected user information.
    private RideInfo launchedRide; // Information about the current ride.

    public UserGUI(UserService userService) throws RemoteException {
        this.userService = userService; // Initialize the user service.
        setupModel(); // Set up the model.
        setupView(); // Set up the view.
    }

    protected void setupModel() throws RemoteException {
        this.userService.registerGUI(this); // Register this GUI with the user service.
    }
    ...
    protected void setupView() throws RemoteException {
        ...
        userDropdown = new JComboBox<>(new Vector<>(userService.getUsers())); // Dropdown for user selection.
